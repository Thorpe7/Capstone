...
def plot_err_graphs(repo_to_plot_from: str, output_name: str) -> None:
    # tmp_df = pd.read_csv(
    #     "/home/thorpe/git_repos/Capstone/results/performance_metrics/training_validation_acc.csv",
    # )
    plain18_df = pd.read_csv(
        f"/home/thorpe/git_repos/Capstone/results/performance_metrics/{repo_to_plot_from}/plain18/training_validation_acc.csv",
    )
    plain34_df = pd.read_csv(
        f"/home/thorpe/git_repos/Capstone/results/performance_metrics/{repo_to_plot_from}/plain34/training_validation_acc.csv",
    )
    ...
    # err_tmp_df = pd.DataFrame(
    #     {
    #         "Iterations": tmp_df["Epochs"] * 391,
    #         "TrainingErrorRate": 100 - tmp_df["TrainingAccuracy"],
    #         "ValidationErrorRate": 100 - tmp_df["ValidationAccuracy"],
    #     }
    # )
    ...
    data_columns = [col for col in err_plain34_df.columns if col != "Iterations"]
    ...
    for data_column in data_columns:
        ...
        if data_column == "ValidationErrorRate":
            line_thickness = 2
        # plt.plot(
        #     err_tmp_df["Iterations"],
        #     err_tmp_df[data_column],
        #     label=data_column + " Default",
...
if __name__ == "__main__":
    plot_err_graphs("cifar", "resnet34_error_rate")
