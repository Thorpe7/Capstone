...
class CifarResNetBlockwPool(nn.Module):
    def __init__(
        self,
        in_channels,
        out_channels,
        ...
        super(CifarResNetBlockwPool, self).__init__()
...
class CifarResNetwPool(nn.Module):
    def __init__(
        self,
        Block: nn.Module,
        num_layers: list,
        ...
        super(CifarResNetwPool, self).__init__()
