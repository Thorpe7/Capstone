...
class PlainCNNwDropout(
    ...
    def __init__(
        ...
        super(PlainCNNwDropout, self).__init__()
    ...
    def forward(self, x):
        ...
        # x = self.dropout(x) # Dropout after reshape to minimize overfitting from dense layer
        x = self.fc(x)
...
if __name__ == "__main__":
    TestCNN = PlainCNNwDropout(CNNBlock, [6, 8, 12, 6], 1, 4)
