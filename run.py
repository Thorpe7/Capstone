...
from source.dataset_formatting import curate_torch_csv, find_smallest_img_dim
from source.dataloader import custom_dataloader
from source.resnet34_arch import ResNet, Block
from source.model_train import (
    train_model,
    test_model,
    compute_accuracy,
...
test_dataset, test_loader = custom_dataloader(
    "data_v1/Testing/", transform=data_transform, testing_flag=True, batch_size=batch_size
)
...
trained_model = train_model(model, train_loader, valid_loader, num_epochs, batch_size, learning_rate, DEVICE)
