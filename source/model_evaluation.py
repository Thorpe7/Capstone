...
from source.resnet34_arch import ResNet
...
def create_roc_calc_auc(y_test: list, y_score: list) -> Tuple[ndarray,ndarray,ndarray,float]:
    """"""
...
def plot_roc_auc(fpr:ndarray, tpr:ndarray, thresholds:ndarray, roc_auc:float) -> plt:
    """"""
    plt.figure()
    lw = 2
